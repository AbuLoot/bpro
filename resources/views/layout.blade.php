...
<head>
  ...
  <title>@yield('meta_title', 'B Pro')</title>
  <meta name="description" content="@yield('meta_description', 'B Pro')">
...
<body class="bg-light">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background-color: #e3f2fd;" aria-label="Main navigation">
    <div class="container-xl">
      <a class="navbar-brand" href="/">
        <img src="/img/logo-light.png" alt="Logo" width="115" height="47">
      </a>
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="container">
      ...
      <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="mb-3 mb-md-0 text-muted">© {{ date('Y') }} B Pro</span>
      </div>
